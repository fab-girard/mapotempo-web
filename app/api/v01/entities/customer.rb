...
class V01::Entities::Customer < Grape::Entity
  ...
  expose(:capacity_1, documentation: { type: Integer, desc: "Default capacity 1"})
  expose(:unit_1, documentation: { type: String, desc: "Default unit's type for capacity 1"})
  expose(:capacity_2, documentation: { type: Integer, desc: "Default capacity 2" })
  expose(:unit_2, documentation: { type: String, desc: "default unit's type for capacity 2"})
