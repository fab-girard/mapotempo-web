...
class V01::Vehicles < Grape::API
  ...
  helpers do
    ...
    def vehicle_params
      ...
      p.permit(:contact_email, :ref, :name, :emission, :consumption, :capacity, :capacity_unit, :capacity_alt, :capacity_unit_alt, :color, :tomtom_id, :masternaut_ref, :router_id, :router_dimension, :speed_multiplicator)
    end
