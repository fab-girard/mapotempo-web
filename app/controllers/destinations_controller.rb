...
class DestinationsController < ApplicationController
  ...
  def destination_params
    params.require(:destination).permit(:ref, :name, :street, :detail, :postalcode, :city, :country, :lat, :lng, :phone_number, :comment, :geocoding_accuracy, :geocoding_level, tag_ids: [], visits_attributes: [:id, :ref, :quantity, :quantity_alt, :take_over, :open1, :close1, :open2, :close2, :_destroy, tag_ids: []])
  end
