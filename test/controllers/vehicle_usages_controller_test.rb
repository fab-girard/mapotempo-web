...
class VehicleUsagesControllerTest < ActionController::TestCase
  ...
  test 'should update vehicle_usage' do
    patch :update, id: @vehicle_usage, vehicle_usage: { vehicle: {capacity: 123, color: @vehicle_usage.vehicle.color, consumption: @vehicle_usage.vehicle.default_consumption, emission: @vehicle_usage.vehicle.default_emission, name: @vehicle_usage.vehicle.name},  open: @vehicle_usage.open}
